...
#import "ZCYAnimation.h"

#import <QuartzCore/QuartzCore.h>

#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 100000 //假如固件是iOS10 控制器self就遵守CAAnimationDelegate协议
@interface ZCYAnimation () <CAAnimationDelegate>
#else //固件低于iOS 10, 否则就不遵守CAAnimationDelegate协议 无需填写
@interface ZCYAnimation ()
#endif
@end

@implementation ZCYAnimation

static ZCYAnimation *instance = nil;
+ (ZCYAnimation *)defaultZCY {
...
#pragma mark - ZCY Animation Methods
