...
#import "ZCYTextView.h"

#define kTopY 7.0
#define kLeftX 5.0

@interface ZCYTextView() <UITextViewDelegate>
...
- (void)addTextViewBeginEvent:(void (^)(ZCYTextView *))begin {
    _BeginBlock=begin;
}

- (void)addTextViewEndEvent:(void (^)(ZCYTextView *))End {
    _EndBlock=End;
}
...
- (void)textViewBeginNoti:(NSNotification*)noti {
    ...
    if (_BeginBlock) {
        void(^begin)(ZCYTextView *text)=_BeginBlock;
        begin(self);
    }
}
...
- (void)textViewEndNoti:(NSNotification*)noti {
    ...
    if (_EndBlock) {
        void(^end)(ZCYTextView *text)=_EndBlock;
        end(self);
    }
}
...
- (void)DidChange:(NSNotification*)noti {
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(ZCYTextView *text) =_eventBlock;
