 ...
 * @since 1.0.0
 */
- (void)reader:(ZCYQRCodeReader * _Nullable)reader didScanResult:(NSString * _Nullable)result;
 ...
 * @since 1.0.0
 */
- (void)readerDidCancel:(ZCYQRCodeReader * _Nullable)reader;
 ...
 */
@interface ZCYQRCodeReader : UIViewController
