...
@interface ZCYClassMethods () <CAAnimationDelegate>
#else //固件低于iOS 10, 否则就不遵守CAAnimationDelegate协议 无需填写
@interface ZCYClassMethods ()
#endif
...
@implementation ZCYClassMethods

+ (void)ZCY_adjustInterfaceOrientation:(UIInterfaceOrientation)orientation {
...
+ (void)initNavigationControllerWithRootViewController:(UIViewController *)viewController
    ...
    ZCYNavigationController *childNC = [[ZCYNavigationController alloc] initWithRootViewController:viewController];
